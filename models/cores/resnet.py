...
class BasicBlock(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None, groups=1,
        ...
        self.bn1 = norm_layer(planes, **kwargs)
...
class ResNet(nn.Module):
    ...
    def __init__(self, core_config, block, layers, num_classes=1000,
        ...
        self.bn1 = self._norm_layer(self.inplanes, **core_config)
        self.relu = nn.ReLU(inplace=True)
        self.maxpool = nn.MaxPool2d(kernel_size=3, stride=2, padding=1)
        self.layer1 = self._make_layer(block, 64, layers[0], **core_config)
    ...
    def _make_layer(self, block, planes, blocks, stride=1, dilate=False, **kwargs):
        ...
        if stride != 1 or self.inplanes != planes * block.expansion:
            downsample = nn.Sequential(
                ...
                norm_layer(planes * block.expansion, **kwargs),
            )
...
def _resnet(arch, core_config, block, layers, pretrained, progress, **kwargs):
    model = ResNet(core_config, block, layers)
    if pretrained:
...
def resnet34(core_config):
    ...
    Args:
        ...
        progress (bool): If True, displays a progress bar of the download to stderr
    """
    return _resnet('resnet34', core_config, BasicBlock, [3, 4, 6, 3], core_config['pretrained'], True)


def resnet50(core_config):
    ...
    Args:
        ...
        progress (bool): If True, displays a progress bar of the download to stderr
    """
    return _resnet('resnet50', core_config, Bottleneck, [3, 4, 6, 3], core_config['pretrained'], True)
